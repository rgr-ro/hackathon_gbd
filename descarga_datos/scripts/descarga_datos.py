...
# Directorio donde se guardarán los CSV directos de 2023
directorio_destino = os.path.join("data", "csv")
...
directorio_destino_totales = os.path.join("data", "csv", "all_csv")
